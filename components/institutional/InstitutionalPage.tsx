...
import SliderJS from "../ui/SliderJS.tsx";
      ...
      {device == "desktop"
        ? (
          <div className="content pb-[40px] overflow-x-hidden">
            ...
            {!hide.block1 && (
              <div class="institucionalInfo__1 w-full max-w-[1150px] ml-auto mr-auto table rounded-none lg:mt-[56px]">
                <span class="institucionalInfo__1-img float-left">
                  {block1 && <img src={block1?.backgroundImage} />}
                </span>
                <span class="institucionalInfo__1-texts text-center text-xl lg:text-[28px] lg:w-[calc(100%-680px)] float-right mt-[74px] text-black">
                  {block1 && (
                    <div
            ...
            {!hide.block2 && (
              <div class="institucionalInfo__2 table rounded-none w-full py-9 px-0 mt-4 bg-[#efefef]">
                <div class="content block w-full max-w-[1150px] ml-auto mr-auto pb-[40px]">
                  ...
                  <span class="institucionalInfo__2-texts float-left text-black mt-[94px] lg:w-[calc(100%-660px)]">
                    {block2 && (
                      <div
              ...
              <div className="institucionaltimeline">
                ...
                <div className="institucionaltimeline__slide">
                  <div id={id} className="content">
                    ...
                    <Slider.JS rootId={id} interval={0 * 1e3} infinite />
                  </div>
                </div>
              </div>
            )}
        ...
        : (
          <div className="content lg:pb-[40px]">
            <div
              class="institucionalBanner relative block z-[18] "
              style={{
                background: `url(${backgroundImage}) center no-repeat`,
            ...
            {!hide.block1 && (
              <div class="institucionalInfo__1 w-full max-w-[1150px] ml-auto mr-auto table rounded-none lg:mt-[56px]">
                ...
                <span class="institucionalInfo__1-texts text-xl px-4 text-center lg:text-[28px] lg:w-[calc(100%-680px)] float-right mt-[74px] text-black">
                  {block1 && (
                    <div
                      dangerouslySetInnerHTML={{ __html: block1?.text || "" }}
                    />
