...
export default function PageContent(
  ...
  return (
    <>
      ...
      <div
        className={`m-auto w-full max-w-[1440px] flex sm:py-16 py-4 justify-center items-center
        ${
          pageType == "Vertical"
      ...
      >
        {device !== "desktop" && (
          <div className="content--bloco-text-intitucional lg:w-1/2 pt-6">
        ...
        <div className="content--bloco-img-intitucional flex flex-col">
          <div className="element-img-institucional py-4 lg:w-1/2">
            {device == "desktop"
              ? (
                <img
                  src={desktop}
        ...
        {device === "desktop" && (
          <div className="content--bloco-text-intitucional lg:w-1/2">
            <div className="conteiner-paragraph-intitucional mx-[5%] sm:mx-[10%]">
              <div
                className="element-text-institucional"
                dangerouslySetInnerHTML={{ __html: content }}
